[![Run App TraysonCombs](https://github.com/traysoncombs/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/traysoncombs/GithubActions/actions/workflows/run-app.yaml)
